...
export default function SearchContainer({
  ...
  return (
    <div
      className={`fixed z-10 h-[800px] w-[640px] translate-x-[-50%] rounded-2xl bg-gray-50 p-10 shadow transition-transform duration-500 ease-in-out ${isOpen ? 'visible translate-y-0 opacity-100' : 'invisible translate-y-full opacity-0'}`}
